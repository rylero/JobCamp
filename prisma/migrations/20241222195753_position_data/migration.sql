...
CREATE TABLE `Event` (
    ...
    INDEX `Event_schoolId_fkey`(`schoolId`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `Student` (
    ...
    INDEX `Student_lotteryPositionId_fkey`(`lotteryPositionId`),
...
CREATE TABLE `PositionsOnStudents` (
    ...
    INDEX `PositionsOnStudents_studentId_fkey`(`studentId`),
...
CREATE TABLE `Company` (
    ...
    INDEX `Company_schoolId_fkey`(`schoolId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Host` (
    ...
    INDEX `Host_companyId_fkey`(`companyId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
