...
<div class="flex flex-col w-96 h-96 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 justify-center items-center gap-8 border-4 bg-slate-100">
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        <button on:click={studentSignup} class="w-24 h-10 rounded bg-blue-500 text-white hover:bg-blue-600">Student</button>
        <button on:click={companySignup} class="w-24 h-10 rounded bg-blue-500 text-white hover:bg-blue-600">Company</button>
    </div>
